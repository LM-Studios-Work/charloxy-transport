      ...
      <header className="glass fixed inset-x-0 top-0 z-50 border-b border-navy/10">
        <nav className="container-wide flex h-[72px] items-center justify-between" aria-label="Global">
          ...
          <div className="hidden items-center justify-end gap-5 lg:flex">
            ...
            <Link href="/quote" className="whitespace-nowrap rounded-md bg-gold px-6 py-2.5 text-sm font-bold text-navy hover:bg-gold/90">Get An Estimate</Link>
          </div>
          ...
          <>
            ...
            >
              ...
              <div className="mt-auto flex flex-col gap-4 border-t border-navy/15 pt-6">
                ...
                <Link href="/quote" onClick={closeMobile} className="rounded-md bg-gold px-5 py-4 text-center font-bold text-navy">Get An Estimate</Link>
              </div>
            </motion.aside>
          </>
        )}
