    ...
    <main className="overflow-hidden bg-background">
      <section className="container-wide pb-20 pt-8 md:pb-24 md:pt-14">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-end lg:gap-16">
          <div>
            <p className="font-display text-sm uppercase tracking-[.2em] text-gold">05 / Ad-hoc Freight</p>
            <h1 className="display-tight mt-5 max-w-3xl text-6xl text-navy md:text-8xl">General goods. <span className="text-gold">Safely moved.</span></h1>
            <p className="mt-7 max-w-xl text-lg leading-8 text-ink-muted">Need a one-off load moved? From pallets to event equipment and unique freight, we provide flexible transport solutions for general goods that don't fit in a standard car.</p>
          ...
          <div className="photo-card relative min-h-[390px] bg-navy md:min-h-[520px]">
            ...
            <p className="absolute bottom-6 left-6 max-w-xs font-display text-3xl uppercase leading-none text-background">Flexible. Professional. Fast.</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-navy/10 bg-navy py-7 text-background">
        <div className="container-wide flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-col items-center gap-3 text-center md:items-end md:text-right">
            <p className="max-w-md text-sm leading-6 text-background/70">Whatever goods you are moving, they are automatically covered against transit damage up to R150,000.</p>
      ...
      <section className="container-wide py-20 md:py-28">
        <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
          <div>
            ...
            <h2 className="display-tight mt-3 text-5xl text-navy md:text-6xl">We handle the <span className="text-gold">heavy lifting.</span></h2>
          </div>
      ...
      <section className="container-wide pb-20">
        <div className="flex flex-col gap-6 rounded-[1.5rem] bg-navy p-8 md:flex-row md:items-center md:justify-between md:p-12">
          <div>
            ...
            <p className="mt-3 max-w-lg text-sm leading-6 text-background/70">Let us know what you need transported and we'll give you a quick price.</p>
          </div>
