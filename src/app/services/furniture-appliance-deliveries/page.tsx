    ...
    <main className="overflow-hidden bg-background">
      <section className="container-wide pb-20 pt-8 md:pb-24 md:pt-14">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-end lg:gap-16">
          <div>
            <p className="font-display text-sm uppercase tracking-[.2em] text-gold">02 / Bulky item transport</p>
            <h1 className="display-tight mt-5 max-w-3xl text-6xl text-navy md:text-8xl">Heavy lifting. <span className="text-gold">Handled.</span></h1>
            <p className="mt-7 max-w-xl text-lg leading-8 text-ink-muted">Bought something big and need it home? We provide fast, safe transport for bulky furniture, heavy appliances, and single large items across Gauteng.</p>
      ...
      <section className="border-y border-navy/10 bg-navy py-7 text-background">
        <div className="container-wide flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-col items-center gap-3 text-center md:items-end md:text-right">
            <p className="max-w-md text-sm leading-6 text-background/70">Your new fridge or vintage couch is automatically covered against transit damage up to R150,000.</p>
      ...
      <section className="bg-paper py-20 md:py-28">
        <div className="container-wide">
          ...
          <h2 className="display-tight mt-3 max-w-3xl text-5xl text-navy md:text-7xl">Store to door, <span className="text-gold">made simple.</span></h2>
      ...
      <section className="container-wide pb-20">
        <div className="flex flex-col gap-6 rounded-[1.5rem] bg-navy p-8 md:flex-row md:items-center md:justify-between md:p-12">
          <div>
            ...
            <p className="mt-3 max-w-lg text-sm leading-6 text-background/70">Let us know what you need moved and we'll give you a quick price.</p>
          </div>
