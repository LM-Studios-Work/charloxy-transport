    ...
    <main className="overflow-hidden bg-background">
      <section className="container-wide pb-20 pt-8 md:pb-24 md:pt-14">
        <nav className="flex items-center gap-2 text-sm font-semibold text-ink-muted">
          ...
          <span className="text-navy">Transport Services for Businesses</span>
        </nav>
        <div className="mt-8 grid gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-end lg:gap-16">
          <div>
            <h1 className="display-tight mt-5 max-w-3xl text-6xl text-navy md:text-8xl">Business <span className="text-gold">Transport.</span></h1>
      ...
      <section className="border-y border-navy/10 bg-navy py-7 text-background">
        <div className="container-wide flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-col items-center gap-3 text-center md:items-end md:text-right">
            <p className="max-w-md text-sm leading-6 text-background/70">Protect your commercial assets. Every load is automatically covered against transit damage up to R150,000 at no extra cost.</p>
      ...
      <section className="container-wide py-20 md:py-28">
        <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
          <div>
            <p className="font-display text-sm uppercase tracking-[.14em] text-gold">Commercial logistics</p>
            <h2 className="display-tight mt-3 text-5xl text-navy md:text-7xl">Support for your <span className="text-gold">daily operations.</span></h2>
          </div>
          <div>
            <p className="text-lg leading-8 text-ink-muted">Managing corporate logistics requires reliability and discretion. We offer structural support for your business, whether you require monthly retainer delivery routes, one-off stock transfers between retail branches, or a complete corporate office relocation across the city.</p>
            <p className="mt-5 text-lg leading-8 text-ink-muted">Our teams act as an extension of your own workforce. We provide the necessary fleet vehicles, professional handlers, and loading materials to manage your inventory and equipment. Our focus is entirely on maintaining your operational timeline and ensuring secure transport from collection to final delivery.</p>
          </div>
        </div>
      </section>
