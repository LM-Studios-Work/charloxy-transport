...
import { ArrowLeft, ArrowRight, Check, MapPin, ShieldCheck, Truck } from 'lucide-react';
...
export const metadata = { title: 'Home & Office Moving | Charloxy Transport', description: 'Residential and commercial moving services across greater Johannesburg.' };
    ...
    <main className="overflow-hidden bg-background">
      <section className="container-wide pb-20 pt-8 md:pb-24 md:pt-14">
        <nav className="flex items-center gap-2 text-sm font-semibold text-ink-muted">
          ...
          <span className="text-navy">Home &amp; Office Moving</span>
        </nav>
        <div className="mt-8 grid gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-end lg:gap-16">
          <div>
            <h1 className="display-tight mt-5 max-w-3xl text-6xl text-navy md:text-8xl">Home &amp; Office <span className="text-gold">Moving.</span></h1>
            <p className="mt-7 max-w-xl text-lg leading-8 text-ink-muted">Moving across Johannesburg requires practical knowledge of regional logistics, including heavy traffic routes, strict estate access protocols, and building regulations. We provide structured relocation services to manage these variables efficiently.</p>
          ...
          <div className="photo-card relative min-h-[390px] bg-navy md:min-h-[520px]">
            <img src="/moving_truck.jpg" alt="Movers carrying furniture into a new home" className="absolute inset-0 size-full object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-navy/90 via-navy/15 to-transparent" />
            <p className="absolute bottom-6 left-6 max-w-xs font-display text-3xl uppercase leading-none text-background">Residential or commercial. Handled properly.</p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-navy/10 bg-navy py-7 text-background">
        <div className="container-wide flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-col items-center gap-3 text-center md:items-end md:text-right">
            <p className="max-w-md text-sm leading-6 text-background/70">Every move is automatically covered by up to R150,000 in Goods in Transit Insurance at no extra cost.</p>
      ...
      <section className="container-wide py-20 md:py-28">
        <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
          <div>
            <p className="font-display text-sm uppercase tracking-[.14em] text-gold">Relocation logistics</p>
            <h2 className="display-tight mt-3 text-5xl text-navy md:text-7xl">Transport built for <span className="text-gold">your requirements.</span></h2>
          </div>
          <div>
      ...
      <section className="bg-paper py-20 md:py-28">
        <div className="container-wide">
          ...
          <h2 className="display-tight mt-3 max-w-3xl text-5xl text-navy md:text-7xl">Less disruption. <span className="text-gold">More control.</span></h2>
      ...
      <section className="container-wide py-20 md:py-28">
        <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
          <div>
            ...
            <h2 className="display-tight mt-3 text-5xl text-navy md:text-6xl">Relocation requirements, <span className="text-gold">properly covered.</span></h2>
          </div>
      ...
      <RelatedServices currentSlug="home-office-moving" />
      ...
      <section className="container-wide pb-20">
        <div className="flex flex-col gap-6 rounded-[1.5rem] bg-navy p-8 md:flex-row md:items-center md:justify-between md:p-12">
          <div>
            <p className="font-display text-4xl uppercase text-background md:text-5xl">Ready to move?</p>
            <p className="mt-3 max-w-lg text-sm leading-6 text-background/70">Tell us what is moving, where it is going, and when you need a hand, and we will provide a quick estimate.</p>
          </div>
