  ...
  return <div className="overflow-hidden bg-background">
    <section className="container-wide pt-5 pb-8 md:pt-7 md:pb-24">
      <div className="relative min-h-[540px] overflow-hidden rounded-[1.75rem] bg-navy lg:min-h-[700px] lg:flex lg:flex-row lg:justify-between">
        ...
        <div className="relative flex min-h-[540px] flex-col justify-end gap-5 p-7 md:min-h-0 md:p-12 lg:min-h-[700px] lg:justify-center lg:max-w-md xl:max-w-xl 2xl:max-w-2xl">
          <p className="font-display text-sm uppercase tracking-[.15em] text-gold">Reliable. Safe. On time.</p>
          <h1 className="display-tight max-w-2xl text-4xl text-background sm:text-6xl md:text-7xl lg:text-6xl xl:text-7xl 2xl:text-8xl"><span className="whitespace-nowrap">Johannesburg&apos;s</span> <span className="text-gold">Trusted Movers.</span></h1>
        ...
        <div className="relative mx-5 hidden lg:mr-8 lg:mt-10 lg:mb-10 lg:block lg:w-[380px] lg:self-center lg:shrink-0 xl:w-[480px] 2xl:w-[560px]">
          <EstimateForm />
        </div>
      </div>
    </section>
    ...
    <section className="bg-paper py-20 md:py-28">
      <div className="container-wide grid items-center gap-12 lg:grid-cols-2">
        <div className="flex flex-col lg:pr-6">
          ...
          <div className="mt-2 flex items-center gap-10 sm:gap-14 md:gap-20 lg:gap-8 xl:gap-16 2xl:gap-28">
            <div className="flex flex-col items-start">
              <h2 className="display-tight text-[2.5rem] leading-[1.1] text-navy sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl 2xl:text-7xl">R150k Transit</h2>
              <h2 className="display-tight text-[2.5rem] leading-[1.1] text-gold sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl 2xl:text-7xl">Insurance.</h2>
            </div>
            <img 
              src="/insurance%20badge.png" 
              alt="R150k Transit Insurance badge" 
              className="size-32 shrink-0 scale-110 object-contain drop-shadow-md sm:size-36 md:size-48 lg:size-40 xl:size-48 2xl:size-56" 
            />
          </div>
    ...
    <section className="bg-gold py-5"><Link href="/quote" className="container-wide flex flex-wrap items-center justify-center gap-x-8 gap-y-2 font-display text-2xl uppercase text-navy md:justify-between md:text-4xl hover:opacity-80 transition-opacity"><span>Get an estimate</span><ArrowRight className="hidden md:block" /><span className="hidden md:block">Get an estimate</span><ArrowRight className="hidden md:block" /><span className="hidden md:block">Get an estimate</span></Link></section>
  </div>;
}
